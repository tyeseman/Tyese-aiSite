...
Version 0.4.1 keeps universal page-type governance and fixes Elementor body rendering by saving generated intro/grid layouts as valid top-level sections instead of nesting sections inside columns.
